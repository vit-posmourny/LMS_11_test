...
<div class="page-body">
    <div class="container-xl">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.custom-page.update', ['custom_page' => $custom_page->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="editor" name="description" placeholder="Enter page description">{!! $custom_page->description !!}</textarea>
