    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Create Footer Column One</h3>
                <div class="card-actions">
                    <a href="{{ route('admin.footer-column-one.store') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                <form action="{{ route('admin.footer-column-one.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-input-block name="title" placeholder="Enter column title"/>
                        </div>
                        <div class="col-md-6">
