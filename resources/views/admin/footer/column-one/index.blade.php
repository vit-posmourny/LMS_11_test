        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Footer Column One</h3>
                    <div class="card-actions">
                        <a href="{{ route('admin.footer-column-one.create') }}" class="btn btn-primary">
                                ...
                                @forelse ($columnOne as $column)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.footer-column-one.destroy', $column->id) }}" class="text-red delete__item">
