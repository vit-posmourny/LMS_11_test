                            ...
                            <tbody>
                                @forelse ($columnTwo as $column)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.footer-column-two.edit', $column->id) }}" class="btn-sm btn-primary">
                                                <x-tabler-icon icon="edit" class="icon-tabler" sprite="outline"/>
                                            </a>
                                            <a href="{{ route('admin.footer-column-two.destroy', $column->id) }}" class="text-red delete__item">
