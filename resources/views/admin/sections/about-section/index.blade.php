            ...
            <div class="card-body">
                <form action="{{ route('admin.about-section.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <x-image-preview src="{{ asset($about->image) }}" style="background-color: #b3b3b3"/>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <x-image-preview src="{{ asset($about->learner_image) }}" style="background-color: #b3b3b3"/>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <x-image-preview src="{{ asset($about->video_image) }}" style="background-color: #b3b3b3"/>
