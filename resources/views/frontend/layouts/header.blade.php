        ...
        <div class="row">
            <div class="col-xxl-4 col-lg-7 col-md-8 d-none d-md-block">
                <ul class="wsus__header_left d-flex flex-wrap">
                    <li><a href="mailto:{{ $topBar->email }}"><x-tabler-icon icon="mail" class="icon-tabler"/>{{ $topBar->email }}</a></li>
                    <li><a href="callto:{{ $topBar->phone }}"><x-tabler-icon icon="phone" class="icon-tabler" sprite="outline"/> {{ $topBar->phone }}</a></li>
            ...
            <div class="col-xxl-5 col-lg-7 d-none d-xxl-block">
                <div class="wsus__header_center">
                    <p>
                        <span> {{ $topBar->offer_name }}</span> {{ $topBar->offer_short_description }} <a href="{{ $topBar->offer_button_url }}">{{ $topBar->offer_button_text }}</a>
                    </p>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg main_menu main_menu_3">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="menu_category">
                <div class="icon">
                    <img src="{{ Vite::asset('resources/images/grid_icon.png') }}" alt="Category" class="img-fluid">
                </div>
                Category
                <ul>
            ...
            <ul class="navbar-nav m-auto">
                ...
                @foreach ($customPages as $customPage)
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('custom-page', ['slug' => $customPage->slug]) }}">{{ $customPage->title }}</a>
                    </li>
                @endforeach
            </ul>
                ...
                <ul>
                    <li>
                        <a class="menu_signin" href="{{ route('cart.index') }}">
                            <span>
                                <img src="{{ Vite::asset('resources/images/cart_icon_black.png') }}" alt="user" class="img-fluid">
                            </span>
                    ...
                    <li>
                        <a class="admin" href="#">
                            <span>
                                <img src="{{ Vite::asset('resources/images/user_icon_black.png') }}" alt="user" class="img-fluid">
                            </span>
                            admin
                        </a>
                    </li>
