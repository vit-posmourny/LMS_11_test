...
@section('content')
    <!--===========================
        BREADCRUMB START
    ============================-->
    <section class="wsus__breadcrumb course_details_breadcrumb" style="background: url({{ asset(config('settings.site_breadcrumb')) }});">
                ...
                <div class="row">
                    <div class="col-12 wow fadeInUp">
                        <div class="wsus__breadcrumb_text">
                            ...
                            <ul class="list">
                                <li>
                                    <span><img src="{{ $course->instructor->avatar }}" alt="user" class="img-fluid"></span>
                    ...
                    <div class="wsus__courses_sidebar">
                        ...
                        <div class="wsus__courses_sidebar_instructor">
                            <div class="image_area d-flex flex-wrap align-items-center">
                                <div class="img">
                                    <img src="{{ asset($course->instructor->avatar) }}" alt="Instructor" class="img-fluid">
                                </div>
                                <div class="text">
